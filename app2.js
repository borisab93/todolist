...
// This is one model that use above schema
...
//Creating an array that will store all three basic items
const defaultItems = [item1, item2, item3];

// Creating a schema for each list
const listSchema = {
    name: String,       //name of the list
    items: [itemSchema] //array based schema items
}
